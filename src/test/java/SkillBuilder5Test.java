...
class SkillBuilder5Test {
    ...
    void findTYPattern_1() {
        String expected = "";
        String actual = SkillBuilder5.findTYPattern("If the forest is blue, then what?");
    ...
    void findTYPattern_2() {
        ...
        String actual = SkillBuilder5.findTYPattern("I am checking this"+randStr+"testy.");
        assertEquals(expected,actual,"Expecting: "+expected+"\nActual: "+actual);
    }
    ...
    void findTYPattern_3() {
        ...
        String actual = SkillBuilder5.findTYPattern("I AM CHECKING THIS"+randStr+"TEST THOUROUGHLY DUDE!");
        assertEquals(expected,actual,"Expecting: "+expected+"\nActual: "+actual);
    }
}